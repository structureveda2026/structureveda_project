...
// Fallback mock blogs for seamless offline testing
...
export const blogService = {
  ...
  async getAdminBlogs(params: BlogFilterParams = {}): Promise<{
    ...
    try {
      ...
      const res = await api.get(`/admin/library/blogs?${query.toString()}`);
  ...
  async getAdminBlogById(id: string): Promise<BlogPost> {
    try {
      const res = await api.get(`/admin/library/blogs/${id}`);
      if (res.success && res.data) {
        return res.data;
      }
    } catch (err) {
  ...
  async createBlog(data: CreateBlogPostInput): Promise<BlogPost> {
    try {
      const res = await api.post("/admin/library/blogs", data);
      if (res.success && res.data) {
        return res.data;
      }
    } catch (err) {
  ...
  async updateBlog(id: string, data: UpdateBlogPostInput): Promise<BlogPost> {
    try {
      const res = await api.put(`/admin/library/blogs/${id}`, data);
      if (res.success && res.data) {
        return res.data;
      }
    } catch (err) {
  ...
  async deleteBlog(id: string): Promise<boolean> {
    try {
      const res = await api.del(`/admin/library/blogs/${id}`);
  ...
  async toggleBlogStatus(id: string, status: BlogStatus): Promise<BlogPost> {
    try {
      const res = await api.patch(`/admin/library/blogs/${id}/status`, { status });
      if (res.success && res.data) {
        return res.data;
      }
    } catch (err) {
  ...
  async toggleBlogFeatured(id: string, isFeatured: boolean): Promise<BlogPost> {
    try {
      const res = await api.patch(`/admin/library/blogs/${id}/featured`, { isFeatured });
      if (res.success && res.data) {
        return res.data;
      }
    } catch (err) {
  ...
  async getBlogStats(): Promise<BlogStats> {
    try {
      const res = await api.get("/admin/library/blogs/stats");
      if (res.success && res.data) {
        return res.data;
      }
    } catch (err) {
