...
import deityDashavataraCardImg from "../../assets/images/library/deities/deity-dashavatara.jpg";
import deityPanchayatanaCardImg from "../../assets/images/library/deities/deity-panchayatana.jpg";
import deity33DevasCardImg from "../../assets/images/library/deities/deity-33-devas.jpg";
...
export const VEDA_CARD_IMAGES = {
  ...
  dashavatara: deityDashavataraCardImg,
  ...
  panchayatana: deityPanchayatanaCardImg,
  vaidika33Deva: deity33DevasCardImg,
  devataAvatara: deityDashavataraCardImg,
};
      ...
      // -----------------------------------------------------------------------
      {
        ...
        children: [
          ...
          // 3. Dashavatara Tattva
          {
            ...
            cardImage: deityDashavataraCardImg,
            ...
            children: [
              ...
              },
              {
                ...
                badge: "Dvapara Yuga",
                content: {
                  sanskrit: "वसुदेवसुतं देवं कंसचाणूरमर्दनम्।\nदेवकीपरमानन्दं कृष्णं वन्दे जगद्गुरुम्॥\n(वहसि वपुषि विशदे वसनं जलदाभं - जयदेव)",
                  transliteration: "vasudevasutaṃ devaṃ kaṃsacāṇūramardanam |\ndevakīparamānandaṃ kṛṣṇaṃ vande jagadgurum ||\n(vahasi vapuṣi viśade vasanaṃ jaladābhaṃ - jayadeva)",
                  meaningHi: "कंस और चाणूर जैसे असुरों का दलन करने वाले, देवकी के परमानन्द स्वरूप और संपूर्ण जगत् के गुरु भगवान श्रीकृष्ण को हम वंदन करते हैं। द्वापर युग में उन्होंने गीता का अमर उपदेश देकर धर्म की पुनः स्थापना की।",
                  meaningEn: "I salute Lord Krishna, the supreme Guru of the universe, son of Vasudeva, slayer of Kamsa and Chanura, and the supreme joy of Mother Devaki. In Dvapara Yuga, He revealed the eternal wisdom of the Bhagavad Gita.",
                  metadata: { yuga: "Dvapara Yuga", teachings: "Srimad Bhagavad Gita (18 Chapters)", abode: "Dvaraka / Goloka", source: "Krishna Ashtakam / Gita Govinda 8" },
                },
              },
              {
                id: "avatar-9-buddha",
          ...
          // 4. Smarta Panchayatana Devas
          {
            ...
            tagline: {
              en: "Surya, Ganesha, Ambika (Devi), Shiva, and Vishnu — The Fivefold Manifestation of One Supreme Reality",
              hi: "सूर्य, गणेश, अम्बिका (शक्ति), शिव, एवं विष्णु — एक परब्रह्म के पाँच दिव्य स्वरूप",
            },
            cardImage: deityPanchayatanaCardImg,
            childLevelName: { en: "Deity / Vidhi", hi: "देवता / विधान" },
            children: [
              {
                id: "panchayatana-vidhi",
                parentId: "panchayatana-deva",
                type: "leaf",
                levelLabel: { en: "Tradition & Mandala", hi: "परंपरा एवं मण्डल" },
              ...
              {
                id: "panchayatana-surya",
                parentId: "panchayatana-deva",
                type: "leaf",
                levelLabel: { en: "Deity 1", hi: "प्रथम देव" },
                title: { en: "01. Sri Surya Deva: The Solar Vital Energy (Prana & Gayatri)", hi: "०१. श्री सूर्य देव: प्रत्यक्ष देव, तेज एवं स्वास्थ्य प्रदाता" },
                shortTitle: { en: "01. Surya", hi: "०१. सूर्य" },
                sanskrit: "ध्येयः सदा सवितृमण्डलमध्यवर्ती नारायणः",
                badge: "Tejas & Prana",
                content: {
                  sanskrit: "ध्येयः सदा सवितृमण्डलमध्यवर्ती नारायणः सरसिजासनसन्निविष्टः।\nकेयूरवान् मकरकुण्डलवान् किरीटी हारी हिरण्मयवपुर्धृतशङ्खचक्रः॥\nआदित्यस्य नमस्कारं ये कुर्वन्ति दिने दिने। आयुः प्रज्ञा बलं वीर्यं तेजस्तेषां च जायते॥",
                  transliteration: "dhyeyaḥ sadā savitṛmaṇḍalamadhyavartī nārāyaṇaḥ sarasijāsanasanniviṣṭaḥ |\nkeyūravān makarakuṇḍalavān kirīṭī hārī hiraṇmayavapurdhṛtaśaṅkhacakraḥ ||\nādityasya namaskāraṃ ye kurvanti dine dine | āyuḥ prajñā balaṃ vīryaṃ tejasteṣāṃ ca jāyate ||",
                  meaningHi: "जो सूर्यमण्डल के मध्य में विराजमान, कमल पर आसीन, स्वर्णमयी कान्ति वाले, मकराकृत कुण्डल और मुकुट धारण करने वाले हैं, उन सूर्यनारायण का हम नित्य ध्यान करते हैं। जो प्रतिदिन सूर्य को नमस्कार और अर्घ्य देते हैं, उनकी आयु, प्रज्ञा, बल, वीर्य और तेज में निरंतर वृद्धि होती है।",
                  meaningEn: "Always meditate upon Lord Narayana resplendent at the center of the solar disc, seated upon a lotus, adorned with divine gems and radiant golden light. Those who offer reverent salutations to Surya daily are bestowed with vitality, intellect, strength, and luminous aura.",
                  metadata: {
                    direction: "South-East (Agneya) in Vishnu Panchayatana / Center in Surya Panchayatana",
                    bijaMantra: "Om Hram Hrim Hraum Sah Suryaya Namah",
                    element: "Agni / Light / Prana",
                  },
                },
              },
              {
                id: "panchayatana-ganesha",
                parentId: "panchayatana-deva",
                type: "leaf",
                levelLabel: { en: "Deity 2", hi: "द्वितीय देव" },
                title: { en: "02. Sri Ganesha: Lord of Wisdom & Remover of Obstacles", hi: "०२. श्री गणेश: विघ्नहर्ता, बुद्धिदाता एवं प्रथम पूज्य" },
                shortTitle: { en: "02. Ganesha", hi: "०२. गणेश" },
                ...
                content: {
                  ...
                  transliteration: "vakratuṇḍa mahākāya sūryakoṭisamaprabha |\nnirvighnaṃ kuru me deva sarvakāryeṣu sarvadā ||\nekadantaṃ mahākāyaṃ taptakāñcanasannibham | lambodaraṃ viśālākṣaṃ vande'haṃ gaṇanāyakam ||",
                  meaningHi: "हे घुमावदार सूंड वाले, विशाल देह वाले और करोड़ों सूर्यों के समान दिव्य तेजस्वी भगवान गणेश! आप सदा हमारे सभी कार्यों को विघ्न-रहित पूर्ण करें। एकदन्त, स्वर्णमयी कान्ति और ज्ञान के सागर गणराज को हमारा प्रणाम।",
                  meaningEn: "O Lord with the curved trunk and immense cosmic form, whose brilliance rivals millions of suns, please make all my endeavors free of impediments forever. Salutations to the single-tusked Ganesha, the lord of wisdom and auspicious beginnings.",
                  metadata: {
                    direction: "South-West (Nairritya) in Vishnu Panchayatana / Center in Ganesha Panchayatana",
                    bijaMantra: "Om Gam Ganapataye Namah",
                    element: "Prithvi / Stability / Discernment",
                  },
                },
              },
              {
                id: "panchayatana-ambika",
                parentId: "panchayatana-deva",
                type: "leaf",
                levelLabel: { en: "Deity 3", hi: "तृतीय देव" },
                title: { en: "03. Devi Ambika: Primordial Cosmic Shakti & Universal Mother", hi: "०३. भगवती अम्बिका / दुर्गा: पराशक्ति, मातृकृपा एवं सर्वमंगल" },
                shortTitle: { en: "03. Ambika", hi: "०३. अम्बिका" },
                sanskrit: "सर्वमङ्गलमाङ्गल्ये शिवे सर्वार्थसाधिके",
                badge: "Parashakti",
                content: {
                  ...
                  meaningHi: "हे सर्वमंगलमयी! हे कल्याणकारी शिवे! हे धर्म, अर्थ, काम, मोक्ष को सिद्ध करने वाली, शरणागतवत्सला, त्रिनेत्री गौरी नारायणी! आपको बारंबार नमस्कार है। सृष्टि, स्थिति और संहार की अधिष्ठात्री सनातन शक्ति को हमारा प्रणाम।",
                  meaningEn: "Salutations to You, O Auspiciousness of all that is auspicious! Benevolent Devi, fulfiller of every spiritual and worldly goal, refuge of the helpless, three-eyed Gauri Narayani, prostrations unto You!",
                  metadata: {
                    direction: "North-West (Vayavya) in Vishnu Panchayatana / Center in Shakta Panchayatana",
                    bijaMantra: "Om Dum Durgayai Namah / Aim Hrim Klim Chamundayai Viche",
                    element: "Vayu / Creative Kinetic Energy",
                  },
                },
              },
              {
                id: "panchayatana-shiva",
                parentId: "panchayatana-deva",
                type: "leaf",
                levelLabel: { en: "Deity 4", hi: "चतुर्थ देव" },
                title: { en: "04. Sri Shiva: Auspicious Transformer & Lord of Liberation", hi: "०४. भगवान शिव / महेश: संहार, कल्याण एवं परमानन्द" },
                shortTitle: { en: "04. Shiva", hi: "०४. शिव" },
                sanskrit: "कर्पूरगौरं करुणावतारं संसारसारम्",
                badge: "Laya & Moksha",
                content: {
                  sanskrit: "कर्पूरगौरं करुणावतारं संसारसारं भुजगेन्द्रहारम्।\nसदा वसन्तं हृदयारविन्दे भवं भवानीसहितं नमामि॥\nॐ नमः शिवाय शुभदं शुभकारकम्।",
                  transliteration: "karpūragauraṃ karuṇāvatāraṃ saṃsārasāraṃ bhujagendrahāram |\nsadā vasantaṃ hṛdayāravinde bhavaṃ bhavānīsahitaṃ namāmi ||\noṃ namaḥ śivāya śubhadaṃ śubhakārakam |",
                  meaningHi: "जो कर्पूर के समान धवल गौर वर्ण वाले, करुणा के साक्षात् अवतार, संपूर्ण संसार के सार और सर्पराज का हार पहनने वाले हैं; जो सदा भक्तों के हृदय कमल में वास करते हैं, उन भगवान शिव को माता भवानी सहित प्रणाम है।",
                  meaningEn: "I salute Lord Shiva, white as camphor, embodiment of boundless compassion, essence of all cosmic existence, adorned with the serpent king. He who dwells eternally within the lotus of the heart, united with Mother Bhavani.",
                  metadata: {
                    direction: "North-East (Ishanya) in Vishnu Panchayatana / Center in Shiva Panchayatana",
                    bijaMantra: "Om Namah Shivaya",
                    element: "Akasha / Pure Transcendent Space & Consciousness",
                  },
                },
              },
              {
                id: "panchayatana-vishnu",
                parentId: "panchayatana-deva",
                type: "leaf",
                levelLabel: { en: "Deity 5", hi: "पञ्चम देव" },
                title: { en: "05. Sri Vishnu: Preserver & Sustainer of Cosmic Dharma", hi: "०५. भगवान विष्णु: पालनकर्ता, धर्मसंस्थापक एवं वैकुण्ठपति" },
                shortTitle: { en: "05. Vishnu", hi: "०५. विष्णु" },
                sanskrit: "शान्ताकारं भुजगशयनं पद्मनाभं सुरेशम्",
                badge: "Sthiti & Dharma",
                content: {
                  sanskrit: "शान्ताकारं भुजगशयनं पद्मनाभं सुरेशं विश्वाधारं गगनसदृशं मेघवर्णं शुभाङ्गम्।\nलक्ष्मीकान्तं कमलनयनं योगिभिर्ध्यानगम्यं वन्दे विष्णुं भवभयहरं सर्वलोकैकनाथम्॥",
                  transliteration: "śāntākāraṃ bhujagaśayanaṃ padmanābhaṃ sureśaṃ viśvādhāraṃ gaganasadṛśaṃ meghavarṇaṃ śubhāṅgam |\nlakṣmīkāntaṃ kamalanayanaṃ yogibhirdhyānagamyaṃ vande viṣṇuṃ bhavabhayaharaṃ sarvalokaikanātham ||",
                  meaningHi: "जिनका स्वरूप शांत है, जो शेषनाग की शय्या पर शयन करते हैं, जिनकी नाभि से सृष्टि का कमल प्रस्फुटित होता है, जो देवताओं के ईश्वर और सम्पूर्ण ब्रह्माण्ड के आधार हैं, उन भवभय-हारी भगवान श्रीविष्णु को हमारा सादर नमन।",
                  meaningEn: "I bow to Lord Vishnu, personification of transcendent serenity, resting upon the cosmic serpent Shesha, support of the entire universe, beloved of Lakshmi, and dispeller of all worldly distress.",
                  metadata: {
                    direction: "Center in Vishnu Panchayatana / South-West in Shiva Panchayatana",
                    bijaMantra: "Om Namo Bhagavate Vasudevaya",
                    element: "Jala / All-Pervading Cosmic Consciousness",
                  },
                },
              },
            ],
          ...
          // 5. The 33 Koti (Types) Vedic Devas
          {
            ...
            cardImage: deity33DevasCardImg,
            childLevelName: { en: "Deva Varga", hi: "देव वर्ग" },
            children: [
              {
              ...
              {
                id: "vaidika-ashta-vasus",
                parentId: "vaidika-33-deva",
                type: "leaf",
                levelLabel: { en: "Group 1", hi: "प्रथम वर्ग" },
                title: { en: "01. The 8 Vasus (Ashta-Vasus): The Elemental Spheres of Dwelling", hi: "०१. अष्ट वसु: सृष्टि के आठ मूल भौतिक एवं प्राकृतिक आधार" },
                shortTitle: { en: "01. Ashta Vasus", hi: "०१. अष्ट वसु" },
                sanskrit: "अग्निश्च पृथिवी च वायुश्चान्तरिक्षं चैते वसवः",
                badge: "8 Elemental Spheres",
                content: {
                  sanskrit: "कतमे वसव इत्यग्निश्च पृथिवी च वायुश्चान्तरिक्षं चादित्यश्च द्यौश्च चन्द्रमाश्च नक्षत्राणि चैते वसव एतेषु हीदँ सर्वँ हितमिति तस्माद्वसव इति॥",
                  transliteration: "katame vasava ityagniśca pṛthivī ca vāyuścāntarikṣaṃ cādityaśca dyauśca candramāśca nakṣatrāṇi caite vasava eteṣu hīdaom sarvaom hitamiti tasmādvasava iti ||",
                  meaningHi: "८ वसु कौन से हैं? १. अग्नि (तेज), २. पृथ्वी (धरा), ३. वायु (पवन), ४. अन्तरिक्ष (आकाश-मण्डल), ५. आदित्य (सूर्य), ६. द्यौ (स्वर्ग/द्युलोक), ७. चन्द्रमा (सोम), और ८. नक्षत्र (तारामण्डल)। क्योंकि यह सम्पूर्ण चराचर जगत् इन्हीं आठ में निवास (वास) करता है और ये सबमें वास करते हैं, इसलिए इन्हें 'वसु' कहा जाता है।",
                  meaningEn: "Who are the Vasus? Fire (Agni), Earth (Prithvi), Air (Vayu), Atmosphere (Antariksha), Sun (Aditya), Sky (Dyaus), Moon (Chandrama), and Stars (Nakshatra). Because all life and matter dwell within them, and they abide in all beings, they are called the Vasus.",
                  metadata: {
                    category: "Ashta Vasus (अष्ट वसु)",
                    function: "The 8 spatial and material dimensions necessary for physical existence",
                    source: "Brihadaranyaka Upanishad 3.9.3 / Shatapatha Brahmana",
                  },
                },
              },
              {
                id: "vaidika-ekadasha-rudras",
                parentId: "vaidika-33-deva",
                type: "leaf",
                levelLabel: { en: "Group 2", hi: "द्वितीय वर्ग" },
                title: { en: "02. The 11 Rudras (Ekadasha-Rudras): Vital Pranas & Inner Consciousness", hi: "०२. एकादश रुद्र: शरीर के १० प्राण एवं ११वाँ मन/जीवात्मा" },
                shortTitle: { en: "02. 11 Rudras", hi: "०२. एकादश रुद्र" },
                sanskrit: "दशेमे पुरुषे प्राणा आत्मैकादशः",
                badge: "11 Pranas & Atman",
                content: {
                  sanskrit: "कतमे रुद्रा इति दशेमे पुरुषे प्राणा आत्मैकादशस्ते यदास्माच्छरीरान्मर्त्यादुत्क्रामन्त्यथ रोदयन्ति तद्यद्रोदयन्ति तस्माद्रुद्रा इति॥",
                  transliteration: "katame rudrā iti daśeme puruṣe prāṇā ātmaikādaśaste yadāsmāccharīrānmartyādutkrāmantyatha rodayanti tadyadrodayanti tasmādrudrā iti ||",
                  meaningHi: "११ रुद्र कौन से हैं? मनुष्य के शरीर में स्थित १० प्राण (प्राण, अपान, व्यान, उदान, समान, नाग, कूर्म, कृकल, देवदत्त, धनंजय) और ११वाँ मन (अथवा जीवात्मा)। जब ये इस नश्वर शरीर को त्यागकर उत्क्रमण करते हैं, तब संबंधियों को रुलाते हैं; इसलिए इन्हें 'रुद्र' कहा जाता है।",
                  meaningEn: "Who are the Rudras? The ten vital life-energies (Pranas) within a person, plus the eleventh, the Mind/Self. When they depart from this mortal body, they cause tears to flow from loved ones, hence they are reverently called the Rudras.",
                  metadata: {
                    category: "Ekadasha Rudras (एकादश रुद्र)",
                    function: "The 11 life-principles governing respiration, digestion, movement, perception, and awareness",
                    source: "Brihadaranyaka Upanishad 3.9.4",
                  },
                },
              },
              {
                id: "vaidika-dvadasha-adityas",
                parentId: "vaidika-33-deva",
                type: "leaf",
                levelLabel: { en: "Group 3", hi: "तृतीय वर्ग" },
                title: { en: "03. The 12 Adityas (Dvadasha-Adityas): The Solar Cycles of Time", hi: "०३. द्वादश आदित्य: संवत्सर (वर्ष) के १२ मास एवं कालचक्र" },
                shortTitle: { en: "03. 12 Adityas", hi: "०३. द्वादश आदित्य" },
                sanskrit: "द्वादश मासाः संवत्सरस्यैत आदित्याः",
                badge: "12 Solar Months",
                content: {
                  sanskrit: "कतमे आदित्या इति द्वादश मासाः संवत्सरस्यैत आदित्या एते हीदं सर्वमाददाना यन्ति तद्यदिदं सर्वमाददाना यन्ति तस्मादादित्या इति॥",
                  transliteration: "katame ādityā iti dvādaśa māsāḥ saṃvatsarasyaita ādityā ete hīdaṃ sarvamādadānā yanti tadyadidaṃ sarvamādadānā yanti tasmādādityā iti ||",
                  meaningHi: "१२ आदित्य कौन से हैं? संवत्सर (वर्ष) के १२ महीने ही बारह आदित्य हैं (धाता, मित्र, अर्यमा, रुद्र, वरुण, सूर्य, भग, विवस्वान्, पूषा, सविता, त्वष्टा, विष्णु)। ये निरंतर चलते हुए सब जीवों की आयु और उनके कर्मफलों का आहरण (ग्रहण) करते हुए काल चक्र चलाते हैं; इसलिए इन्हें 'आदित्य' कहते हैं।",
                  meaningEn: "Who are the Adityas? The twelve months of the solar year are the twelve Adityas. As they elapse, they take away (adadana) the life-spans of all mortals, continuously turning the wheel of cosmic time and evolution.",
                  metadata: {
                    category: "Dvadasha Adityas (द्वादश आदित्य)",
                    names: "Dhatri, Mitra, Aryaman, Rudra, Varuna, Surya, Bhaga, Vivasvan, Pushan, Savitri, Tvashtri, Vishnu",
                    source: "Brihadaranyaka Upanishad 3.9.5",
                  },
                },
              },
              {
                id: "vaidika-indra-prajapati",
                parentId: "vaidika-33-deva",
                type: "leaf",
                levelLabel: { en: "Group 4", hi: "चतुर्थ वर्ग" },
                title: { en: "04. Indra & Prajapati: Cosmic Kinetic Power & Continuous Creation", hi: "०४. इन्द्र एवं प्रजापति: ब्रह्माण्डीय विद्युत् शक्ति एवं यज्ञ" },
                shortTitle: { en: "04. Indra & Prajapati", hi: "०४. इन्द्र-प्रजापति" },
                sanskrit: "स्तनयित्नुरेवेन्द्रो यज्ञः प्रजापतिरिति",
                badge: "Power & Sacrifice",
                content: {
                  sanskrit: "कतमोऽशनिः कतमो यज्ञ इति स्तनयित्नुरेवेन्द्रो यज्ञः प्रजापतिरिति कतमः स्तनयित्नुरिति विद्युदिति कतमो यज्ञ इति पशव इति॥",
                  transliteration: "katamo'śaniḥ katamo yajña iti stanayitnurevendro yajñaḥ prajāpatiriti katamaḥ stanayitnuriti vidyuditi katamo yajña iti paśava iti ||",
                  meaningHi: "इन्द्र कौन हैं और प्रजापति कौन हैं? महर्षि याज्ञवल्क्य ने कहा: गर्जना और विद्युत् (आकाशीय ऊर्जा/वज्र) ही 'इन्द्र' हैं, जो ब्रह्माण्ड की समस्त गतिमान व संहारक शक्ति के प्रतीक हैं। और 'यज्ञ' (समर्पण, परोपकार और निरंतर सृजन) ही 'प्रजापति' हैं, जिनके द्वारा यह सृष्टि निरंतर पोषित और संचालित होती है।",
                  meaningEn: "Who is Indra and who is Prajapati? Indra is the cosmic lightning and electrical energy (the supreme force of vitality and kinetic dynamism). Prajapati is the cosmic principle of Yajna (the continuous law of sacrifice, mutual interdependence, and sustenance of universal life).",
                  metadata: {
                    indraPrinciple: "Vidyut (Cosmic Kinetic Force / Thunder / Willpower)",
                    prajapatiPrinciple: "Yajna (The Universal Law of Cyclic Sacrifice & Sustenance)",
                    source: "Brihadaranyaka Upanishad 3.9.6",
                  },
                },
              },
            ],
