import { Heart, Compass, Coins, Shield, Home, Sparkles, ArrowRight } from "lucide-react";
import { HOMA_PURPOSE_CATEGORIES } from "../data/homaCatalogueData";
...
const HomaPurposeSection = ({ selectedPurpose, onSelectPurpose }) => {
  return (
      ...
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="mx-auto max-w-[760px] text-center">
          ...
          <h2 className="mt-2.5 font-serif text-[28px] font-semibold text-[#2b241d] sm:text-[36px] lg:text-[40px]">
            Choose a Homa According to Your Purpose
          </h2>
          <p className="mx-auto mt-3 max-w-[620px] text-[14.5px] leading-relaxed text-[#685c4f] sm:text-[15.5px]">
            In Vedic tradition, each sacred fire offering is aligned with a defined Sankalpa—whether for planetary balance, prosperity, or domestic purification.
          </p>
        </div>
...
export default HomaPurposeSection;
