import { Heart, BookOpen, Users, Sparkles, Calendar, Scroll, ArrowRight } from "lucide-react";
import { PATH_PURPOSE_CATEGORIES } from "../data/pathCatalogueData";
...
const PathPurposeSection = ({ selectedPurpose, onSelectPurpose }) => {
  return (
      ...
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="mx-auto max-w-[760px] text-center">
          ...
          <h2 className="mt-2.5 font-serif text-[28px] font-semibold text-[#2b241d] sm:text-[36px] lg:text-[40px]">
            Find a Path According to Your Purpose
          </h2>
          <p className="mx-auto mt-3 max-w-[620px] text-[14.5px] leading-relaxed text-[#685c4f] sm:text-[15.5px]">
            In the Vedic tradition, each sacred scripture is selected with reverence to support personal devotion, family tranquility, or auspicious milestones.
          </p>
        </div>
...
export default PathPurposeSection;
