import { Flame, ArrowRight, MessageSquareQuote } from "lucide-react";
import { Link } from "react-router-dom";

const YagyaFinalCta = ({ onExploreClick }) => {
  ...
  return (
    <section className="relative overflow-hidden bg-[#18120d] px-5 py-16 text-center sm:px-8 sm:py-24 lg:px-12">
      {/* Ambient Agni Glow */}
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[450px] w-[540px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#d4872b]/14 blur-[130px]" />
      ...
      <div className="relative mx-auto max-w-[820px]">
        ...
        <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 shadow-2xs backdrop-blur-xs">
          <Flame size={13} className="text-[#eab12c]" />
        ...
        <p className="mx-auto mt-4 max-w-[620px] text-[15px] leading-relaxed text-[#d4c5b5] sm:text-[16px]">
          Select your Yagya, choose an available duration and begin your Sankalpa with Veda Structure.
        </p>
