import { MapPin, Compass, ArrowRight, ShieldCheck, Flame } from "lucide-react";

const HomaKashiSection = ({ onSelectMode }) => {
  return (
      ...
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="mx-auto max-w-[760px] text-center">
          ...
          <h2 className="mt-3 font-serif text-[28px] font-semibold text-[#2b241d] sm:text-[36px] lg:text-[40px]">
            Perform Your Homa in Kashi
          </h2>
          <p className="mx-auto mt-3 max-w-[640px] text-[14.5px] leading-relaxed text-[#685c4f] sm:text-[15.5px]">
            Selected Homa services can be arranged in the sacred Kshetra of Kashi subject to ritual, location, and schedule availability.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          ...
          <div className="relative flex flex-col justify-between overflow-hidden rounded-[26px] border border-[#d6b78d] bg-[#fffdfa] p-7 shadow-[0_8px_25px_rgba(80,50,20,0.06)] transition duration-300 hover:border-[#c77722] hover:shadow-[0_12px_32px_rgba(199,119,34,0.12)]">
            <div>
              ...
              <p className="mt-2.5 text-[14px] leading-relaxed text-[#685c4f]">
                Plan your Homa around your sacred Kashi visit. Participate in the opening Sankalpa in person, offer sacred Ahuti directly into the consecrated Havan Kund, and receive Purnahuti blessings.
              </p>

              <ul className="mt-5 space-y-2 text-[12.5px] text-[#735f4b]">
                <li className="flex items-center gap-2">
                  <ShieldCheck size={14} className="text-[#a8641b]" />
                  <span>Physical presence during Pratham Sankalpa and Purnahuti</span>
                </li>
                <li className="flex items-center gap-2">
                  <ShieldCheck size={14} className="text-[#a8641b]" />
                  <span>Conducted at traditional Kashi ritual mandapams</span>
                </li>
              </ul>
            </div>
          ...
          <div className="relative flex flex-col justify-between overflow-hidden rounded-[26px] border border-[#d6b78d] bg-[#fffdfa] p-7 shadow-[0_8px_25px_rgba(80,50,20,0.06)] transition duration-300 hover:border-[#c77722] hover:shadow-[0_12px_32px_rgba(199,119,34,0.12)]">
            <div>
              <div className="flex items-center justify-between">
                <span className="rounded-full bg-[#f4e4cd] px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-[#8e5a1e]">
                  SERVICE-SPECIFIC REMOTE FIRE RITUAL
                </span>
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#faedd9] text-[#b36c1e]">
                  <Compass size={18} />
                </div>
              ...
              <p className="mt-2.5 text-[14px] leading-relaxed text-[#685c4f]">
                Explore Available Remote Homa services. Your Sankalpa is pronounced with your Gotra and Name by proxy, with verified Ahuti completions and consecrated Homa Bhasma dispatch where supported.
              </p>
              ...
              <ul className="mt-5 space-y-2 text-[12.5px] text-[#735f4b]">
                ...
                <li className="flex items-center gap-2">
                  <ShieldCheck size={14} className="text-[#a8641b]" />
                  <span>Service-specific Homa completion updates & Prasad dispatch</span>
                </li>
              </ul>
            </div>
        ...
        <div className="mx-auto mt-8 max-w-[800px] text-center text-[12.5px] text-[#7a6a57]">
          <p>
            * Kashi and Remote availability are service-specific. Veda Structure maintains authentic ritual coordination without making speculative claims of exclusive temple partnerships or guaranteed supernatural outcomes.
          </p>
        </div>
      </div>
    </section>
...
export default HomaKashiSection;
